...
本文档为 AI 助手（如 opencode、Gemini、Claude）提供项目开发指南和注意事项。
...
- 使用小写字母
- 使用连字符分隔（`-`）
- 示例: `quickstart.md`, `access-control.md`, `cloud.md`
...
1. 添加更多平台安装指南（Cloud 服务器已完成，可添加更多细节）
2. 添加 MagicDNS 高级配置文档
3. 添加 Tailscale SSH 详细指南
4. 添加企业级部署指南
5. 添加安全审计和最佳实践
